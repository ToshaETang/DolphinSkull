...
def train(dataset, epochs):
    ...
    # 打開或創建一個檔案來存儲 losses
    loss_file_path = os.path.join(generated_dir, 'losses.txt')
...
if manager.latest_checkpoint:
    print(f"恢復模型，從檢查點繼續: {manager.latest_checkpoint}")
    initial_epoch = int(checkpoint.epoch)  # 從檢查點中恢復 epoch
else:
    print("沒有可用的檢查點，從頭開始訓練")
    initial_epoch = 0  # 如果沒有檢查點，從頭開始
#-------------------------------------------
# 開始訓練
