...
checkpoint_prefix = os.path.join(checkpoint_dir, "0726_ckpt")
...
def generate_and_save_images(model, epoch, test_input):
    ...
    if epoch % 10 == 0:
        plt.savefig(os.path.join('image_at_epoch_0726', 'epoch_{:04d}.png'.format(epoch)))
